...
while True:
    ...
    while True:
        ...
        if pkt[1][0] not in ip and pkt[1][0] != "0.0.0.0" and pkt[1][0] != "127.0.0.1" and pkt[1][0] != "192.168.0.2":
            ...
            if pkt[1][0] not in ip and pkt[1][0].startswith("192.168.0.1"):
                ...
                if responce._responses[0].success or responce._responses[1].success or responce._responses[2].success or \
